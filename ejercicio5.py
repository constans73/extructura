"""
Mostrar en pantalla la palabra que más 
se repita junto con la cantidad de veces que lo hace del capituló número uno de Frankenstein
"""	

capitulo = """Frankenstein, or the Modern Prometheus
...
for palabra in capitulo:
	if capitulo.count(palabra) > maxi:
		repetida = palabra
		maxi = capitulo.count(palabra)
		print (palabra, maxi)


print ("La palabra mas repetida es", repetida, "y se repite", maxi, "veces")
